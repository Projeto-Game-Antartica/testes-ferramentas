...
public class DesafioManagerVegetacao : AbstractScreenReader {
    ...
    public GameObject EsquadroCort, Esquadro, Faca, Espatula, EspatulaPlanta, Planta, PlantaFora, Pote, PoteFull, Saco, SacoFull;
    ...
    public void initializeGame()
    {
        ...
        // start after dicas.time seconds and repeat at dicas.repeatRate rate
