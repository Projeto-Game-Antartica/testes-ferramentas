...
<html>
	<head>
		...
		<title>Antartica Game</title>
		<link href="http://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
		<script type="text/javascript" src="https://code.jquery.com/jquery-2.1.1.min.js"></script>
        <script type="text/javascript" src="/antartica/js/quizz.js"></script>
        <g:external dir="css" file="quizz.css"/>
			...
			<div id="chooseQuestion" class="col s12 m12 l12">
					...
					<div class="col s12 m12 l12">
						<table class="highlight" id="table" style="margin-top: -30px;">
							...
							<g:each in="${quizzInstanceList}" status="i" var="quizzInstance">
								<tr id="tr${quizzInstance.id}" class="selectable_tr" style="cursor: pointer;"
									data-id="${fieldValue(bean: quizzInstance, field: "id")}" data-owner-id="${fieldValue(bean: quizzInstance, field: "ownerId")}"
									data-checked="false">
									<td class="_not_editable">
										<input style="background-color: #727272" id="checkbox-${quizzInstance.id}" class="filled-in" type="checkbox">
										<label for="checkbox-${quizzInstance.id}"></label>
									</td>
									<td>${fieldValue(bean: quizzInstance, field: "title")}</td>
									<td>${fieldValue(bean: quizzInstance, field: "answers")}</td>
									<td>${quizzInstance.answers[quizzInstance.correctAnswer]}</td>
				...
				<div id="editModal" class="modal">
					<div class="modal-content">
						...
						<div class="row">
							<g:form method="post" action="update" resource="${quizzInstance}">
								<div class="row">
								...
								<div class="row">
									<div class="input-field col s9">
										...
										<input class="validate" id="editAnswers3" name="answers4" required="" maxlength="15" type="text" length="15"/>
									</div>
									<div class="col s2">
										<input type="radio" id="editRadio3" name="correctAnswer" value="3" /> <label for="editRadio3">Alternativa correta</label>
									</div>
								</div>
								<input type="hidden" id="quizzID" name="quizzID">
								<div class="col l10">
				...
				<div id="createModal" class="modal">
					<div class="modal-content">
						<h4>Criar Questão</h4>
						<div class="row">
							<g:form action="save" resource="${quizzInstance}">
								<div class="row">
									<div class="input-field col s12">
					...
					<div class="modal-content">
						...
						<div class="row">
							<div class="col s12">
								...
								<ul>
									<li><a href="/antartica/samples/exemploSantoGrauBlocoGelo.csv">Download do arquivo exemplo</a></li>
								</ul>
							</div>
						</div>
						<div class="row">
